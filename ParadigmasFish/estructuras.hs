...
data MiEstructura = UnaEstructura { key1 :: String, key2 :: Int }

-- Ejemplo:
data Botella =
  UnaBotella { color :: String, capacidad :: Int, boquilla :: Bool }
  deriving (Show)

miBotella = UnaBotella "Azul" 500 True

otraBotella = UnaBotella { color = "Rojo", capacidad = 500, boquilla = True }
...
botellaCambiada bot = bot { color = "Rojo" }
